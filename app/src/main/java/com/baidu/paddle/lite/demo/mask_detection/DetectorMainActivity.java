...
public class DetectorMainActivity extends Activity implements View.OnClickListener, CameraSurfaceView.OnTextureChangedListener {
    private static final String TAG = DetectorMainActivity.class.getSimpleName();
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_shutter:
                ...
                synchronized (this) {
                    ...
                    Log.i("DetectorActivityCamera", savedImagePath);
                }
                Toast.makeText(DetectorMainActivity.this, "Save snapshot to " + savedImagePath, Toast.LENGTH_SHORT).show();
                break;
            case R.id.btn_settings:
                startActivity(new Intent(DetectorMainActivity.this, SettingsActivity.class));
                break;
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (grantResults[0] != PackageManager.PERMISSION_GRANTED || grantResults[1] != PackageManager.PERMISSION_GRANTED) {
            new AlertDialog.Builder(DetectorMainActivity.this)
                    ...
                    .setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            DetectorMainActivity.this.finish();
                        }
                    }).show();
        }
    }
